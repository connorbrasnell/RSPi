...
class StockScanner:
	...
	def getApi(self, product_id):
		...
		urlTitle = "https://services-json.electrocomponents.com/service/ProductService/v01_01/JSON/Location/STORE_ID/GB_1/Product/" + str(product_id)
		urlPrice = "https://services-json.electrocomponents.com/service/ProductPriceService/v01_00/JSON/Location/STORE_ID/GB_1/Timezone/UTC/ProductPrices?ProductNumber=" + str(product_id)
		urlStock = "https://services-json.electrocomponents.com/service/ProductStockService/v01_00/JSON/Location/COUNTRY_CODE/GB/ProductStocks?ProductNumber=" + str(product_id)
